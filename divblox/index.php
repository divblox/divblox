...
if (!extension_loaded("IonCube Loader")) {
    header("Location: config/framework/divblox_admin/initialization_wizard/index.php?redirect=1");
}
header("Location: config/framework/divblox_admin/divblox_admin_login.php");