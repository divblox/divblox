...
* a Loader Wizard script to assist with Loader installation (index.php)
...
2. Launch the Loader Wizard script in your browser. For example:
     http://yourdomain/ioncube/index.php
...
2. Copy the index.php script to the root web directory of a
...
2. Copy the index.php script to the root web folder of a
   configured domain on the server
