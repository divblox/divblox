if (typeof component_classes['data_model_api_operation_administration_data_series'] === "undefined") {
	class data_model_api_operation_administration_data_series extends DivbloxDomBaseComponent {
		...
		deleteSelected() {
			dxRequestInternal(getComponentControllerPath(this),
				...
				function(data_obj) {
					...
					this.current_page = 1;
					this.loadPage();
					pageEventTriggered("api_operation_selection_deleted",{});
				}.bind(this),
				function(data_obj) {
		...
		on_item_clicked(id) {
			setGlobalConstrainById("ApiOperation",id);
			pageEventTriggered("api_operation_clicked",{id:id});
		}
	}
