if (typeof component_classes['data_model_ticket_crud'] === "undefined") {
	class data_model_ticket_crud extends DivbloxDomBaseComponent {
		constructor(inputs,supports_native,requires_native) {
			super(inputs,supports_native,requires_native);
			// Sub component config start
			this.sub_component_definitions = [
				{"component_load_path":"data_model/ticket_crud_data_series","parent_element":"data_series","arguments":{"uid":this.getUid()+"_ticket_crud_data_series_component"}},
				{"component_load_path":"data_model/ticket_crud_update","parent_element":"data_update","arguments":{"uid":this.getUid()+"_ticket_crud_update_component"}},
				{"component_load_path":"data_model/ticket_crud_create","parent_element":"data_create","arguments":{"uid":this.getUid()+"_ticket_crud_create_component"}}];
		...
		eventTriggered(event_name,parameters_obj) {
			...
			switch(event_name) {
				...
				case 'ticket_crud_back_clicked':this.toggleSubView("data_series_wrapper");
					getRegisteredComponent(this.getUid()+"_ticket_crud_data_series_component").reset();
					break;
				default:
		...
		registerDomEvents() {
			getComponentElementById(this,"button_create").on("click", function() {
				pageEventTriggered("ticket_crud_create_clicked",{});
			});
			getComponentElementById(this,"button_create_back").on("click", function() {
				pageEventTriggered("ticket_crud_back_clicked",{});
			});
	...
	component_classes['data_model_ticket_crud'] = data_model_ticket_crud;
}