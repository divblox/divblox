if (typeof(on_data_model_account_administration_ready) === "undefined") {
	function on_data_model_account_administration_ready(load_arguments) {
		...
		this.reset = function(inputs) {
			dxLog("Reset for account_administration not implemented");
		}.bind(this);
		...
		this.eventTriggered = function(event_name,parameters_obj) {
			...
			switch(event_name) {
				case 'account_administration_create_clicked':this.toggleSubView("data_create_wrapper");
					getRegisteredComponent("account_administration_create_component").reset();
					break;
				case 'account_clicked':this.toggleSubView("data_update_wrapper");
					getRegisteredComponent("account_administration_update_component").reset(parameters_obj.id);
					break;
				case 'account_created':
				case 'account_deleted':
				case 'account_updated':
				case 'account_administration_back_clicked':this.toggleSubView("data_series_wrapper");
					getRegisteredComponent("account_administration_data_series_component").reset();
					break;
				default:
		...
		this.sub_components =
			{"0":{"component_load_path":"data_model/account_administration_data_series","parent_element":"data_series","loading_arguments":{"uid":"account_administration_data_series_component"}},
			"1":{"component_load_path":"data_model/account_administration_update","parent_element":"data_update","loading_arguments":{"uid":"account_administration_update_component"}},
			"2":{"component_load_path":"data_model/account_administration_create","parent_element":"data_create","loading_arguments":{"uid":"account_administration_create_component"}}};
