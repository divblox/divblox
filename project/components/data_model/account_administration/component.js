		...
		eventTriggered(event_name,parameters_obj) {
			...
			switch(event_name) {
				...
				case 'account_clicked':this.toggleSubView("data_update_wrapper");
					getRegisteredComponent(this.getUid()+"_account_administration_update_component").reset(parameters_obj.id);
					break;
...
if (typeof(on_data_model_account_administration_ready) === "undefined") {
	function on_data_model_account_administration_ready(load_arguments) {
		...
		// Sub component config start
		this.sub_components =
			{"0":{"component_load_path":"data_model/account_administration_data_series","parent_element":"data_series","loading_arguments":{"uid":this.getUid()+"_account_administration_data_series_component"}},
			"1":{"component_load_path":"data_model/account_administration_update","parent_element":"data_update","loading_arguments":{"uid":this.getUid()+"_account_administration_update_component"}},
			"2":{"component_load_path":"data_model/account_administration_create","parent_element":"data_create","loading_arguments":{"uid":this.getUid()+"_account_administration_create_component"}}};
		// Sub component config end
