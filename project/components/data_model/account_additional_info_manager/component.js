	...
	class data_model_account_additional_info_manager extends DivbloxDomBaseComponent {
		constructor(inputs,supports_native,requires_native) {
			...
			this.sub_component_definitions = [
				{"component_load_path":"data_model/account_additional_info_manager_data_series","parent_element":"data_series","arguments":{"uid":this.getUid()+"_account_additional_info_manager_data_series_component"}},
				{"component_load_path":"data_model/account_additional_info_manager_update","parent_element":"data_update","arguments":{"uid":this.getUid()+"_account_additional_info_manager_update_component"}},
