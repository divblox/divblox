...
class CategoryController extends EntityDataSeriesComponentController {
    ...
    protected $IncludedAttributeArray = ["CategoryLabel","TicketCount",];
    ...
    public function getPage() {
        ...
        foreach ($this->ConstrainByArray as $Relationship) {
            ...
            $QueryCondition = dxQ::AndCondition(
                $QueryCondition,
                dxQ::Equal(
                    dxQN::$EntityNodeNameStr()->$RelationshipNodeStr->Id,
                    $this->getInputValue('Constraining'.$Relationship.'Id',true)
                )
            );
        }
...
$ComponentObj = new CategoryController("subcategory_list");
?>