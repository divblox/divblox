if (typeof componentClasses['data_model_account_account_administration'] === "undefined") {
    class AccountAdministration extends DivbloxDomBaseComponent {
        constructor(inputs, supportsNative, requiresNative) {
            ...
            this.subComponentDefinitions = [
                {
                    "component_load_path": "data_model/account/account_administration_data_series",
                    "parent_element": "data_series",
                    "arguments": {"uid": this.getUid() + "_account_administration_data_series_component"}
                },
                {
                    "component_load_path": "data_model/account/account_administration_update",
                    "parent_element": "data_update",
                    "arguments": {"uid": this.getUid() + "_account_administration_update_component"}
                },
                {
                    "component_load_path": "data_model/account/account_administration_create",
                    "parent_element": "data_create",
                    "arguments": {"uid": this.getUid() + "_account_administration_create_component"}
                }];
        ...
        eventTriggered(event_name, parameters_obj) {
            ...
            switch (event_name) {
                case 'account_administration_create_clicked':
                ...
                case 'account_administration_back_clicked':
                    this.toggleSubView("data_series_wrapper");
    ...
    componentClasses['data_model_account_account_administration'] = AccountAdministration;
}