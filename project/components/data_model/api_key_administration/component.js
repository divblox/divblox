if (typeof component_classes['data_model_api_key_administration'] === "undefined") {
	class data_model_api_key_administration extends DivbloxDomBaseComponent {
		constructor(inputs,supports_native,requires_native) {
			super(inputs,supports_native,requires_native);
			// Sub component config start
			this.sub_component_definitions = [
				{"component_load_path":"data_model/api_key_administration_data_series","parent_element":"data_series","arguments":{"uid":this.getUid()+"_api_key_administration_data_series_component"}},
				{"component_load_path":"data_model/api_key_administration_update","parent_element":"data_update","arguments":{"uid":this.getUid()+"_api_key_administration_update_component"}},
				{"component_load_path":"data_model/api_key_administration_create","parent_element":"data_create","arguments":{"uid":this.getUid()+"_api_key_administration_create_component"}}];
		...
		eventTriggered(event_name,parameters_obj) {
			...
			switch(event_name) {
				case 'api_key_administration_create_clicked':this.toggleSubView("data_create_wrapper");
					getRegisteredComponent(this.getUid()+"_api_key_administration_create_component").reset();
					break;
				case 'api_key_clicked':this.toggleSubView("data_update_wrapper");
					getRegisteredComponent(this.getUid()+"_api_key_administration_update_component").reset(parameters_obj.id);
					break;
				case 'api_key_created':
				case 'api_key_deleted':
				case 'api_key_updated':
				case 'api_key_administration_back_clicked':this.toggleSubView("data_series_wrapper");
	...
	component_classes['data_model_api_key_administration'] = data_model_api_key_administration;
}

if (typeof(on_data_model_api_key_administration_ready) === "undefined") {
	function on_data_model_api_key_administration_ready(load_arguments) {
		...
		this.reset = function(inputs) {
			dxLog("Reset for api_key_administration not implemented");
		...
		// Sub component config start
		this.sub_components =
			{"0":{"component_load_path":"data_model/api_key_administration_data_series","parent_element":"data_series","loading_arguments":{"uid":this.getUid()+"_api_key_administration_data_series_component"}},
			"1":{"component_load_path":"data_model/api_key_administration_update","parent_element":"data_update","loading_arguments":{"uid":this.getUid()+"_api_key_administration_update_component"}},
			"2":{"component_load_path":"data_model/api_key_administration_create","parent_element":"data_create","loading_arguments":{"uid":this.getUid()+"_api_key_administration_create_component"}}};
		// Sub component config end
