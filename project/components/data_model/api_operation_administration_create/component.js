if (typeof component_classes['data_model_api_operation_administration_create'] === "undefined") {
	class data_model_api_operation_administration_create extends DivbloxDomBaseComponent {
		...
		setValues() {
			getComponentElementById(this,"OperationName").val("");
		...
		saveApiOperation() {
			...
			dxRequestInternal(
				...
				function(data_obj) {
					showAlert("Created!");
					pageEventTriggered("api_operation_created",{"api_operation_id":data_obj.Id});
					this.loadApiOperation();
					this.resetValidation();
				}.bind(this),
				function(data_obj) {
