...
class ApiOperationController extends EntityDataSeriesComponentController {
...
$ComponentObj = new ApiOperationController("api_operation_administration_data_series");
?>