if (typeof componentClasses['system_default_image_upload'] === "undefined") {
    class DefaultImageUpload extends DivbloxDomBaseComponent {
            ...
            if (item.appended) {
                ...
                dxRequestInternal(getComponentControllerPath(thisComponent), {
                    ...
                    item.reader.read(function () {
                        ...
                        pageEventTriggered("ImageEdited", data);
                    }, null, true);
                }, function (data) {
                });
            }
    ...
    componentClasses['system_default_image_upload'] = DefaultImageUpload;
}