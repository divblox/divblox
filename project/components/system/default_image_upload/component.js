if (typeof component_classes['system_default_image_upload'] === "undefined") {
	class system_default_image_upload extends DivbloxDomBaseComponent {
	...
	component_classes['system_default_image_upload'] = system_default_image_upload;
}