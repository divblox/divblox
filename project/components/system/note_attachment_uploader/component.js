if (typeof component_classes['system_note_attachment_uploader'] === "undefined") {
	class system_note_attachment_uploader extends DivbloxDomBaseComponent {
		...
		initFileUploader() {
			...
			$('#'+uid+'_file_uploader').fileuploader({
				...
				upload: {
					...
					data: {f:"handleFilePost",AuthenticationToken:getValueFromAppState('dxAuthenticationToken'), note_id: this_component.getLoadArgument("note_id")},
					type: 'POST',
	...
	component_classes['system_note_attachment_uploader'] = system_note_attachment_uploader;
}