if (typeof(on_navigation_bottom_navbar_ready) === "undefined") {
	function on_navigation_bottom_navbar_ready(load_arguments) {
		...
		this.reset = function(inputs) {
			dxLog("Reset for top_navbar not implemented");
		}.bind(this);
